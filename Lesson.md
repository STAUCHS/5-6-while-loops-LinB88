...
Why?
>Beacuse the guess is not being updated so the while loops is always checking if the guess is not equal to my_num. Since this will always be true, the body runs forever.
